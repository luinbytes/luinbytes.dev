...
export const projects: Project[] = [
    ...
    },
    {
        ...
        name: "Sleepr",
        type: "Android App",
        description: "Cycle-aware wake windows, optional live notifications, and private on-device sleep rhythm learning.",
        longDescription: "Sleepr is a quiet Android sleep companion for people who want practical wake guidance without turning bedtime into a dashboard. It suggests cleaner wake windows, can keep a live notification ticker available when enabled, and learns from morning feedback and opt-in screen-usage signals.",
        approach: "Kotlin + Jetpack Compose for the app surface, Room and DataStore for local state, WorkManager for background scheduling, and Android notification primitives for an opt-in wake-time ticker.",
        outcome: "A local-first Android app shaped around calmer bedtime decisions: no account requirement, no social layer, no cloud dependency for the core sleep model.",
        techStack: ["Kotlin", "Jetpack Compose", "Android", "Room", "WorkManager"],
        tags: ["Android", "Sleep", "Health", "Local-first", "Notifications"],
        pageUrl: "/sleepr",
        featured: true,
        lumiApproved: true,
    },
