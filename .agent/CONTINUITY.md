...
- 2026-07-31T02:35Z [USER][CODE] Deleted the obsolete root `design-qa.md` and added root-level ignore rules for `CONTRIBUTING.md`, `CONTEXT.md`, and `AGENTS.md`; tracked files remain tracked.
