/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/f1-gateway-env.d.ts` (hash: d1a76fc0e08b9bf2acc718ebaa87b82d)
// Runtime types generated with workerd@1.20260714.1 2026-07-01 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	OPENF1_ORIGIN: "https://api.openf1.org";
	F1_ROOMS: DurableObjectNamespace<import("./f1-gateway").F1Room>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./f1-gateway");
		durableNamespaces: "F1Room";
	}
